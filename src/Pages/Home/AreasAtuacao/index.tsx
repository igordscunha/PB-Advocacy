    ...
    return(
        <section className="bg-azul-pb p-12">
            ...
            <div className="md:flex md:gap-16 md:justify-center md:py-24">
                ...
                <div className="flex flex-col items-center md:cursor-pointer md:hover:scale-125 md:transition-transform">
                    <img className="rounded-3xl shadow-xl mt-16 w-1/3 md:w-full" src='/images/trabalhista.png' alt='trabalhista'/>
                    <h4 className="text-2xl text-white pt-4 uppercase">Trabalhista</h4>
                </div>

                <div className="flex flex-col items-center md:cursor-pointer md:hover:scale-125 md:transition-transform">
                    <img className="rounded-3xl shadow-xl mt-16 w-1/3 md:w-full" src='/images/digital.png' alt='digital'/>
                    <h4 className="text-2xl text-white pt-4 uppercase">Digital</h4>
                </div>

                <div className="flex flex-col items-center md:cursor-pointer md:hover:scale-125 md:transition-transform">
                    <img className="rounded-3xl shadow-xl mt-16 w-1/3 md:w-full" src='/images/empresarial.png' alt='empresarial'/>
                    <h4 className="text-2xl text-white pt-4 uppercase">Empresarial</h4>
                </div>

                <div className="flex flex-col items-center md:cursor-pointer md:hover:scale-125 md:transition-transform">
                    <img className="rounded-3xl shadow-xl mt-16 w-1/3 md:w-full" src='/images/internacional.png' alt='internacional'/>
